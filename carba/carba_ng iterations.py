...
with open('referenzen.txt', "r") as a, open("Results_NG.txt", "r") as b:
    ...
    for k in range(10000): # 100 wdh
        ...
        for i in range(1, 6):
            d = 2 * 5 + i  # muss umgestellt werden je nach dem welche referenz verwendet werden soll
            TP = FP = FN = TN = 0
            ...
            for j in numbers:
                ...
                if l_ref == 1:
                    ...
                    if l_test == 1:
                        ...
                        TN += 1
                # wenn l_ref = 3 ist sagt der hersteller nicht dass er diese variante erkennen kann, wird deswegen nicht mit reingezählt
            #print([TP, FP, TN, FN])
            if TP + FN == 0:
                sensitivity = None
            else:
