...
with open('referenzen.txt', "r") as ref, open("Results_NG.txt", "r") as test:
    ref = [line.strip().split('\t') for line in ref]
    ...
    for k in range(3):
        ...
        # alle reihen durchgehen bevor zu index 2 jumpen
            ...
            # sensitivity, specifity und accuracy wird für jedes gen berechnet und dann ausgeprintet
